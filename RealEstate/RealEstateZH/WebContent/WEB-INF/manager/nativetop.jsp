...
<script src="<%=path %>/manager/js/raphael-min.js"></script>
</head>
<body>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="${pageContext.request.contextPath }/manager/agency">
                 ...
                 <li>
                    <a class="active" href="${pageContext.request.contextPath }/manager/employee">
                        <i class="fa fa-dashboard"></i>
                        <span>员工信息管理</span>
                    </a>
                </li>
                <li>
                    <a class="active" href="${pageContext.request.contextPath }/manager/user">
                        <i class="fa fa-bullhorn"></i>
                        <span>用户信息管理</span>
                    </a>
                </li>
                <li>
                    <a class="active" href="${pageContext.request.contextPath }/manager/activity">
                        <i class="fa fa-dashboard"></i>
                        <span>活动信息管理</span>
                    </a>
                </li>
                <li>
                    <a class="active" href="${pageContext.request.contextPath }/type/list">
                        <i class="fa fa-dashboard"></i>
                        <span>文章类型管理</span>
                    </a>
                </li>
                 <li>
                    <a class="active" href="${pageContext.request.contextPath }/manager/articlelist">
                        <i class="fa fa-dashboard"></i>
                        <span>文章信息管理</span>
                    </a>
                </li>
                <%-- <li>
                    <a class="active" href="${pageContext.request.contextPath }/manager/ads">
                        <i class="fa fa-dashboard"></i>
                        <span>广告信息管理</span>
                    </a>
                </li>    --%>
