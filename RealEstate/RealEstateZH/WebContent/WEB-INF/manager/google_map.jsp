                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal " id="commentForm" method="get" action="" novalidate="novalidate">
                                    <div class="form-group ">
                                        ...
                                        <div class="col-lg-6">
                                             <label for="cname" class="control-label">0元购房，告别房奴</label>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">文章摘要：</label>
                                        <div class="col-lg-6">
                                             <label for="cname" class="control-label">中国经济高速发展，房贷成为大多数有为青年伤不起的原因之一......</label>
                                        </div>
                                    </div>                                                          
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <label for="ccomment" class="control-label col-lg-3">文章内容：</label>
                                        <div class="col-lg-6">
