					...
					<div class="page-content">
						...
						<div class="row">
								...
								<div>
									...
									<button type="button" id="active" class="btn btn-default btn-sm">
							     	...
							     	<button type="button" id="inactive"  class="btn btn-default btn-sm">
		     						 ...
		     						 <button type="button" id="findroom" class="btn btn-default btn-sm">
							          <span class="glyphicon glyphicon-screenshot"></span> 查看房号
							        </button>
		     						
		     						<button type="button" id="newroom" class="btn btn-default btn-sm">
							          <span class="glyphicon glyphicon-pushpin"></span> 生成房号
							        </button>
		     						
		     						
		     						<form action="http://localhost:8080/RealEstate/building/buildingFind" method="post">
									 <div class="input-group col-md-3" style="float:right;">  
									 	
										   <input type="text" name="building_name" class="form-control" style="height:42px;width:200px;" placeholder="通过楼栋名称，总层数，状态" />  
							...
							<table id="tb" class="table table-bordered table-hover" data-toggle="table" 
											data-url="<%=path %>/building/list" data-pagination="true" data-striped="true">
								<thead>
									<tr>
										<th data-radio="true" data-hidden="building_id"></th>
										
										<th data-field="building_name" >楼栋名称</th>
										<th data-field="buildings.buildings_name">楼盘名称</th>
										<th data-field="total_floor">总层数</th>
										<th data-field="total_lift" >电梯数</th>
										<th data-field="floor_rooms" >每层多少户</th>
										<th data-field="total_room">总户数</th>
										<th data-field="building_status">状态</th>
									</tr>
								</thead>
							</table>
												...
												<div class="modal fade" id="exampleModals" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabels">
													  <div class="modal-dialog" role="document">
													    <div class="modal-content">
													      <div class="modal-header">
													        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
													        <h4 class="modal-title" id="exampleModalLabel">新增楼栋</h4>
													      </div>
													      <div >
													        <form id="modify" method="post" class="form-horizontal" enctype="multipart/form-data" action="http://localhost:8080/RealEstate/building/Buildingadd">
																<input type="hidden" name="building.created_time" value="<%=new Date().toLocaleString()%>">
																
																<div class="form-group">
																	<label class="col-lg-3 control-label">楼盘名称</label>&nbsp;&nbsp;&nbsp;
																	<select name="building.buildings_id" style="width:235px">
																...
																<div class="form-group">
																	<label class="col-lg-3 control-label">楼栋名称</label>
																	<div class="col-lg-5">
																		<input type="text"  class="form-control" name="building.building_name"/>
																	</div>
																</div>
																...
																<div class="form-group">
																	<label class="col-lg-3 control-label">总层数</label>
																	<div class="col-lg-5">
																		<input type="text"  id="total_floor"   class="form-control" name="building.total_floor"/>
																	</div>
																</div>
																
																<div class="form-group">
																	<label class="col-lg-3 control-label">电梯数</label>
																	<div class="col-lg-5">
																		<input type="text"  class="form-control" name="building.total_lift"/>
																	</div>
																</div>
																
																<div class="form-group">
																	<label class="col-lg-3 control-label">每层多少户</label>
																	<div class="col-lg-5">
																		<input type="text" id="floor_rooms"  class="form-control" onmouseleave="return regsave();"  name="building.floor_rooms"/>
																	</div>
																</div>
																...
																<div class="form-group">
																	<label class="col-lg-3 control-label">总户数</label>
																	<div class="col-lg-5">
																		<input type="text"  id="sum"   class="form-control" name="building.total_room"/>
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="col-lg-5">
																		<select name="building.building_status" style="width:205px">
									  ...
									  <div class="modal-dialog" role="document">
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        	 ...
									        	 <form id="from1" method="post" class="form-horizontal" enctype="multipart/form-data" action="http://localhost:8080/RealEstate/building/buildingUpdate">
																   <input type="hidden" name="building.building_id">
																...
																<div class="form-group">
																	<label class="col-lg-3 control-label">总层数</label>
																	<div class="col-lg-5">
																		<input type="text"   id="total_floors"    class="form-control" name="building.total_floor"/>
																	</div>
																</div>
																...
																<div class="form-group">
																	<label class="col-lg-3 control-label">每层多少户</label>
																	<div class="col-lg-5">
																		<input type="text" id="floor_roomss" onmouseleave="return regsaves();" class="form-control"   name="building.floor_rooms"/>
																	</div>
																</div>
																...
																<div class="form-group">
																	<label class="col-lg-3 control-label">总户数</label>
																	<div class="col-lg-5">
																		<input type="text"  id="sums"  class="form-control" name="building.total_room"/>
																	</div>
																</div>
...
<![endif]-->
	...
	<script src="<%=path %>/Js/Ljs/Building/building.js"></script>
	
	<script type="text/javascript" src="<%=path %>/Css/Lcss/bootstrap/dist/js/bootstrapValidator.js"></script>
	
	<script src="<%=path %>/Js/Ljs/Building/budingDonAdd.js"></script>
