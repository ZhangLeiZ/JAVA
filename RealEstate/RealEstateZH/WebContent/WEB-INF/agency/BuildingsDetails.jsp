				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							...
							<!-- 	<div>
									<img style="width：820px;height:530px;"  src="http://localhost:8080/RealEstate/${buildings.buildings_logo}">
								</div> -->
							 ...
							 <div class="col-sm-9">	
								<div class="panel panel-default panel-blog">
							          <div class="panel-body">
							            <h3 class="blogsingle-title">${builds.buildings_name }楼盘</h3>
							            ...
							            <br />
							            <div class="blog-img"><img src="http://localhost:8080/RealEstate/${builds.buildings_logo}" class="img-responsive" alt="" /></div>
							            <div class="mb20"></div>
							            
							            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${builds.buildings_intro }</p>  
							      ...
							      <div class="col-sm-3">
							        <div class="blog-sidebar">
							          ...
							          <ul class="sidebar-list">
							           	<li>所属区域： ${builds.buildings_area }</li>
							            <li>楼盘位置：  ${builds.buildings_address }</li>
							          ...
							          <ul class="sidebar-list">
							          	...
							          	<li>总套数：  ${builds.total_rooms }</li>
							           	<li>咨询电话：  ${builds.buildings_tel }</li>
...
<![endif]-->
	...
	<script type="text/javascript" src="<%=path %>/LyjCss/bootstrap/dist/js/bootstrapValidator.js"></script>
