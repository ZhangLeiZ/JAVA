    ...
    pageEncoding="UTF-8"%>
     ...
     <%
    	String path=request.getContextPath();
   		String buildings=(String)request.getAttribute("buildings");
    %>
<!DOCTYPE html>
<html>
<head>
							 ...
							 <div class="col-sm-9">	
								<div class="panel panel-default panel-blog">
							          <div class="panel-body">
							            <h3 class="blogsingle-title"><%=buildings %>楼盘</h3>
							            ...
							            <br />
							            <div class="blog-img"><img src="http://localhost:8080/RealEstate/${house.house_logo}" class="img-responsive" alt="" /></div>
							            <div class="mb20"></div>
							        ...
							        <div class="authorpanel">
							          <div class="media">
							            ...
							            <div class="media-body event-body">
							              <h4 class="subtitle">简介</h4>
							              <p>${house.house_intro }</p>
							            </div><br/>
							            <div class="media-body event-body">
							      ...
							      <div class="col-sm-3">
							        <div class="blog-sidebar">
							           ...
							           <br><br> <br><br> <br><br>
							          <h3 class="subtitle">户型名称：</h3>
							          ${house.house_name}
							          
							          <div class="mb30"></div>
							          <h3 class="subtitle">面积：</h3>
							          ${house.house_area}平方米
							          
							          <div class="mb30"></div>
							          <h3 class="subtitle">参考单价：</h3>
							          ${house.unit_price }￥
							          
							          <div class="mb30"></div>
							          <h3 class="subtitle">状态：</h3>
							         ${house.house_status }
