						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div>
									...
									<button type="button"  id="Toltual" class="btn btn-default btn-sm">
							...
							<table id="tb" class="table table-bordered table-hover" data-toggle="table" 
											data-url="<%=path %>/buildings/list" data-pagination="true" data-striped="true">
								<thead>
									<tr>
									        ...
									        <input type="hidden"  name="buildings.buildings_id">
									          ...
									          <div class="form-group">
									           ...
									           <div class="form-group">
									            ...
									            <br>
													<select name="buildings.buildings_status" style="width:305px">
