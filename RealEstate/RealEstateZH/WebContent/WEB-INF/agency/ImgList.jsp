									...
									<div  id="container">
										     ...
										     <table  class="table table-hover">
							 					...
							 					<s:iterator value="#request.list" var="d">
										        	<tr>
										        		<td><img style="height:80px;width: 150px" src="http://localhost:8080/RealEstate/${d.img_path}"></td>
										            	<td>${d.img_des}</td>
										                <td>${d.created_time}</td>
														<td>
															<a href="http://localhost:8080/RealEstate/img/add?id=${d.buildings_id}">添加图片</a>
															<a href="http://localhost:8080/RealEstate/img/delete?img.id=${d.id}&img.buildings_id=${d.buildings_id}"  onclick="javascript:if(confirm('删除确认')){return true;}else{return false;}">删除图片</a>
														</td>
