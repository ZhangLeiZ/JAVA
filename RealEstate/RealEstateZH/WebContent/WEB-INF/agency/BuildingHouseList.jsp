...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
     ...
     String string=(String)request.getAttribute("hou");
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div>
									...
									<button type="button" id="active2" class="btn btn-default btn-sm">
							          <span class="glyphicon glyphicon-heart-empty"></span> 激活
							        </button>
     	
							     	<button type="button" id="inactive2"  class="btn btn-default btn-sm">
							...
							<table id="tb" class="table table-bordered table-hover" data-toggle="table" 
											data-url="<%=path %>/house/houselist?id=<%=string %>" data-pagination="true" data-striped="true">
								<thead>
									<tr>
												...
												<div class="modal fade" id="exampleModals" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabels">
													  <div class="modal-dialog" role="document">
													    <div class="modal-content">
													      ...
													      <div >
													        <form id="modify" method="post" class="form-horizontal" enctype="multipart/form-data" action="http://localhost:8080/RealEstate/house/houseAdd2?id=${param.id}">
									  ...
									  <div class="modal-dialog" role="document">
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        	 ...
									        	 <form id="from1" method="post" class="form-horizontal" enctype="multipart/form-data" action="http://localhost:8080/RealEstate/house/houseUpdate2">
