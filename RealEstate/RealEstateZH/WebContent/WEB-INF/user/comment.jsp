...
<body>
	<h3 align="center">评价记录</h3>
	<div class="container">
		<div class="row" style="width: 860px">
			<!-- 表格工具栏-->
			<div id="toolbar" class="btn-group">
						       
		        <button type="button" id="modifyCom" class="btn btn-default btn-sm" style="width: 60px">
		        	<span class="glyphicon glyphicon-pencil"></span> 修改
		        </button>
				
				<button type="button" id="activeCom" class="btn btn-default btn-sm" style="width: 60px">
		            <span class="glyphicon glyphicon-heart-empty"></span> 激活
		        </button>
	
		     	<button type="button" id="inactiveCom" class="btn btn-default btn-sm" style="width: 60px">
				  ...
				  <div class="modal-dialog" role="document">
		            <div class="modal-content">
		                ...
		                <div class="modal-body">
		                   <form id="form1" action="<%=path %>/comment/updateComment" method="post">
		                   		<!--修改  给id赋值  -->
		                   		<input type="hidden" name="comment.comment_id" value="${comment.comment_id }">		                 		                  
			                   	<div class="form-group">
			                        <label for="comment.comment_content">评价内容</label>
			                        <textarea name="comment.comment_content" class="form-control" rows="10"></textarea>
			                    </div>			                    
