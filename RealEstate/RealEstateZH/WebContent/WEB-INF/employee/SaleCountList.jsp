...
<![endif]-->
	...
	<!-- 统计样式 -->
	<link href="<%=path%>/Css/Lcss/plugins/highcharts/highcharts.css" rel="stylesheet"/>
	<script src="<%=path%>/Css/Lcss/plugins/highcharts/highcharts.js"></script>
	<script src="<%=path%>/Css/Lcss/plugins/highcharts/highcharts-zh_CN.js"></script>
	<script src="<%=path%>/Js/Ljs/SaleCount/saleCount.js"></script>
