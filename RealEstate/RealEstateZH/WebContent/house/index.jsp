    ...
    <div id="slider-contents">
        <div class="container text-center">
            <div class="jumbotron">
                ...
                <a class="btn btn-default btn-border btn-lg" href="#" role="button">价格</a>
            </div>
        </div>
    </div>
</div>
<div id="advance-search" class="main-page clearfix">
    <div class="container">
        	...
        	<div></div>
  		  <input type="text" id="location" name="location"  title="可根据省份名称，楼盘名称，风格查找" style="width:400px;height:45px;background-repeat: no-repeat;background-position:50%;margin-left:400px;" id="property-min-area" >
          <button id = "search" type="submit" class="btn btn-default btn-lg text-center">搜索 房产</button>
    </div>
</div><section id="home-property-listing">
<header class="section-header home-section-header text-center">
    <div class="container">
        <h2 class="wow slideInRight">特色物业</h2>
        <p class="wow slideInLeft">合理的服务费用，让您住的安心<br></p>
    </div>
</header>
    <div class="container">
  ...
  <header class="section-header home-section-header ">
    <div class="container">
      	...
      	<div class="js-load-more" id="js-load-more" style="font-size:20px;">加载跟更多......</div>
    </div>
</header>
    </div>
</section>
<section id="announcement-section" class="text-center">
       <div class="container ">
           ...
           <p class="wow slideInRight">让您实时掌握您的房屋动态<br></p>
           <a class="btn" href="#"><img src="<%=path %>/house/assets/images/iso-btn.png" alt="ISO Button"></a>
           <a class="btn" href="#"><img src="<%=path %>/house/assets/images/playstore-btn.png" alt="Play Store Button"></a>
       </div>
</section><section id="home-property-for-rent-listing">
    <header class="section-header home-section-header text-center">
        <div class="container">
            <h2 class="wow slideInLeft">办公条件</h2>
            <p class="wow slideInRight">舒适的办公条件<br></p>
        </div>
    </header>
    <div class="container">
        <div class="row">
         <s:iterator var="c" value="#request.listbuildingsType">
            <div id="property-for-rent-slider">
                <div class="col-lg-4 col-md-6"><article class="property clearfix">
    <figure class="feature-image">
        <a class="clearfix" href="<%=path %>/index/house?buildingsid=${c.buildings_id}"> <img src="<%=path %>/${c.buildings_logo}" alt="Property Image"></a>
    </figure>
    <div class="property-contents">
       <header class="property-header clearfix">
            <div class="pull-left">
                <h6 class="entry-title"><a href="<%=path %>/index/house?buildingsid=${c.buildings_id}">${c.buildings_name }</a></h6>
                <span class="property-location"><i class="fa fa-map-marker"></i> ${c.reception_address }</span>
            </div>
            <button class="btn btn-default btn-price pull-right btn-3d" ><strong>${c.avg_price }</strong></button>
        </header>
        <div class="property-meta clearfix">
            <span><i class="fa fa-arrows-alt"></i> ${building_area }</span>
            <span><i class="fa fa-bed"></i> ${c.house_type }</span>
            <span><i class="fa fa-bathtub"></i> ${c.total_rooms }</span>
            <span><i class="fa fa-cab"></i> ${c.car_station }</span>
        </div>
    </div>
</article></div>
	</div>
    ...
    <header class="section-header home-section-header">
       <div class="container">
           ...
           <p class="wow slideInLeft">打造国内一流的房地产服务平台<br>
               让您买的放心，住的安心</p>
       </div>
    </header>
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-xs-6">
                <div class="feature clearfix">
                    <i class="icon"><img src="<%=path %>/house/assets/images/features/1.png" alt="Feature Icon"></i>
            ...
            <div class="col-md-3 col-xs-6">
                <div class="feature clearfix">
                    <i class="icon"><img src="<%=path %>/house/assets/images/features/2.png" alt="Feature Icon"></i>
            ...
            <div class="col-md-3 col-xs-6">
                <div class="feature clearfix">
                    <i class="icon"><img src="<%=path %>/house/assets/images/features/3.png" alt="Feature Icon"></i>
            ...
            <div class="col-md-3 col-xs-6">
                <div class="feature clearfix">
                    <i class="icon"><img src="<%=path %>/house/assets/images/features/4.png" alt="Feature Icon"></i>
...
$(document).ready(function(){
	  ...
	  $("#search").click(function(){
			 ...
			 var urls ='http://localhost:8080/RealEstate/index/more?location='+locations;
...
function getData(offset,size,url){
	  $.ajax({
	    ...
	    '<figure class="feature-image">'+
	        '<a class="clearfix zoom" href="http://localhost:8080/RealEstate/buildings/xiangqing?buildingsid='+data[i].buildings_id +'"><img data-action="zoom" src="http://localhost:8080/RealEstate/'+data[i].buildings_logo +'" alt="Property Image"></a>'+
	        '<span class="btn btn-warning btn-sale">出售</span>'+
	    '</figure>'+
	    '<div class="property-contents clearfix">'+
	        '<header class="property-header clearfix">'+
	            '<div class="pull-left">'+
	                '<h6 class="entry-title"><a href="http://localhost:8080/RealEstate/buildings/xiangqing?buildingsid='+data[i].buildings_id +'">'+data[i].buildings_name+'</a></h6>'+
	                '<span class="property-location"><i class="fa fa-map-marker"></i>'+data[i].reception_address +'</span>'+
	            '</div>'+
	            '<button class="btn btn-default btn-price pull-right btn-3d"><strong>'+data[i].avg_price +'</strong></button>'+
	        '</header>'+
	        '<div class="property-meta clearfix">'+
	            '<span><i class="fa fa-arrows-alt"></i>'+data[i].building_area +'</span>'+
	            '<span><i class="fa fa-bed"></i>'+data[i].house_type+'</span>'+
	            '<span><i class="fa fa-bathtub"></i>'+data[i].total_rooms +'</span>'+
	            '<span><i class="fa fa-cab"></i>'+data[i].car_station+'</span>'+
	        '</div>'+
	        '<div class="contents clearfix">'+
	            '<p>${c.buildings_intro } </p>'+
	        '</div>'+
	    '</div>'+
	    '</article>'+
	'</div>';
