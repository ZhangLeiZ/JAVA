...
function format(value) {
	return "<img style='width:320;height:50px' src='http://localhost:8080/RealEstate/"+value+"'>";
}

/*function submit() {  
    var project_status = document.getElementById("active").value;  
    alert("ewret");
...
function projectQuery(project_status) {  
    $('#tb').bootstrapTable(  
            "refresh",  
            {  
                url:"http://localhost:8080/RealEstate/house/list"  
            }  
    );  
}  */
