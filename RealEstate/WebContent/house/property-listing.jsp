...
<header id="site-header">
   ...
   <div class="container">
       <h1 class="title wow slideInLeft">梦想家园</h1>
       <ol class="breadcrumb wow slideInRight">
           <li><a href="index.html">家</a></li>
           <li><a href="property-map-view.html">温馨</a></li>
           <li class="active">梦想家园</li>
       </ol>
   </div>
</div>
<div id="advance-search" class="main-page clearfix">
    <div class="container">
        	...
        	<div></div>
  		  <input type="text" id="location" value="省份/名称/年份/风格" name="location" style="width:400px;height:45px;background-repeat: no-repeat;background-position:50%;margin-left:400px;" id="property-min-area" >
...
$(document).ready(function(){
	  var url = 'http://localhost:8080/RealEstate/index/newindexfind';
	  /*初始化*/
	  var counter = 0; /*计数器*/
	  ...
	  $.ajax({
	    ...
	    '<div class="property-contents clearfix">'+
	        '<header class="property-header clearfix">'+
	            '<div class="pull-left">'+
	                '<h6 class="entry-title"><a href="http://localhost:8080/RealEstate/index/house?buildingsid='+data[i].buildings_id +'">'+data[i].buildings_name+'</a></h6>'+
