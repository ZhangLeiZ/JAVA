					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<h1 align="center">预约管理</h1>
								<hr color="green">
								<div>
									
		     						
		     						<form action="http://localhost:8080/RealEstate/appointment/appfind" method="post">
									 <div class="input-group col-md-3" style="float:right;">  
									 	
										   <input type="text" name="empname" class="form-control" style="height:42px;width:200px;" placeholder="通过员工名称" />  
							...
							<table id="tb" class="table table-bordered table-hover" data-toggle="table" 
											data-url="<%=path %>/appointment/list" data-pagination="true" data-striped="true">
								<thead>
									<tr>
										<th data-radio="true" data-hidden="appointment_id"></th>
										
										<th data-field="employee.employee_name" >员工名称</th>  
										<th data-field="user.user_name">用户名称</th>
										<th data-field="app_arrive_time">看房时间</th>
										<th data-field="arrive_time" >真实看房时间</th>
										<th data-field="house.house_name" >户型名称</th> 
										<th data-field="app_status">预约状态</th>
										<th data-field="created_time">创建时间</th>
										<th data-field="appointment_status">状态</th>
									</tr>
								</thead>
							</table>
