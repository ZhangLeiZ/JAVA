			...
			<div class="row">
				<div class="col-xs-12">
					...
					<div>
						...
						<div class="modal fade" id="myModal" data-target="#myModal">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">请选中数据！</div>
						...
						<div class="modal fade" id="status" data-target="#myModal">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">此行数据已激活，无需再次激活！</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-default"
											data-dismiss="modal">Close</button>
									</div>
						...
						<div class="modal fade" id="instatus" data-target="#myModal">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">此行数据已冻结，无需再次冻结！</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-default"
											data-dismiss="modal">Close</button>
									</div>
						...
						<%-- <form action="http://localhost:8080/RealEstate/mission/Findmiss"
							method="post">
							<div class="input-group col-md-3" style="float: right;">

								<input type="text" name="empname"
									class="form-control" style="height: 42px;"
									placeholder="可通过员工名称" /> <span class="input-group-btn">
						...
						<table id="tb" class="table table-bordered table-hover"
							data-toggle="table" data-url="<%=path%>/mission/list"
							data-pagination="true" data-striped="true">
							<thead>
								<tr>
									<th data-radio="true" data-hidden="mission_id"></th>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<form id="from1" method="post" enctype="multipart/form-data"
											action="http://localhost:8080/RealEstate/mission/updateMiss">
											

											<input type="hidden" name="mission.mission_id">
											
											<input type="hidden" name="mission.monthes">
												
											<input type="hidden" name="mission.employee_id">

											<div class="form-group">
												<label for="recipient-name" class="control-label">员工任务量</label>
												<input type="text" class="form-control" id="recipient-name"
													name="mission.quantity">
											</div>

											<div class="form-group">
												<label for="recipient-name" class="control-label">销售提成百分比</label>
												<input type="text" class="form-control" id="recipient-name"
													name="mission.bonus_percent">
											</div>
						...
						<div class="modal fade" id="exampleModals" tabindex="-1"
							role="dialog" aria-labelledby="exampleModalLabels">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal"
										...
										<h4 class="modal-title" id="exampleModalLabel">新增绩效</h4>
									</div>
									<div>
										<form id="modify" method="post" class="form-horizontal"
											action="<%=path%>/mission/missionAdds">
											<div class="form-group">
												<label class="col-lg-3 control-label">员工名称</label>
												<div class="col-lg-5">
													<select name="mission.employee_id" style="width: 235px">
											...
											<div class="form-group">
												<label class="col-lg-3 control-label">员工任务量</label>
												<div class="col-lg-5">
											...
											<div class="form-group">
												<label class="col-lg-3 control-label">月份</label>
												<div class="col-lg-5">
													<select class="form-control" name="mission.monthes">
											...
											<div class="form-group">
												<label class="col-lg-3 control-label">销售提成百分比</label>
												<div class="col-lg-5">
													<input type="text" class="form-control"
														name="mission.bonus_percent" />
												</div>
...
<![endif]-->
	...
	<script src="<%=path%>/Js/Ljs/Mission/missionAdd.js"></script>
	<script src="<%=path%>/Js/Ljs/Mission/mission.js"></script>


	<script type="text/javascript"
		src="<%=path%>/Css/Lcss/bootstrap/dist/js/bootstrapValidator.js"></script>
