...
<![endif]-->
	...
	<script type="text/javascript" src="<%=path %>/Css/Lcss/bootstrap/dist/js/bootstrapValidator.js"></script>
	 ...
	 <!-- 报表 -->
	 <link href="<%=path%>/Js/Ljs/Room/highcharts/highcharts.css" rel="stylesheet"/> 
	 <script type="text/javascript" src="<%=path%>/Js/Ljs/Room/highcharts/highcharts.js"></script>
	 <script type="text/javascript" src="<%=path%>/Js/Ljs/Room/highcharts/highcharts-zh_CN.js"></script>
	 <script type="text/javascript" src="<%=path%>/Js/Ljs/Room/highcharts/highcharts-3d.js"></script>
	 <script type="text/javascript" src="<%=path%>/Js/Ljs/Room/highcharts/exporting.js"></script>
	 <script type="text/javascript" src="<%=path%>/Js/Ljs/Room/highcharts/jquery-1.8.3.min.js"></script>
	 <script src="<%=path%>/Js/Ljs/Room/roomCount.js"></script>
