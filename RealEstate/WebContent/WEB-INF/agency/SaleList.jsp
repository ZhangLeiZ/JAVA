					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<h1 align="center">销售管理</h1>
								<hr color="green">
								<div>
									
					
							<table id="tb" class="table table-bordered table-hover" data-toggle="table" 
											data-url="<%=path %>/sale/list" data-pagination="true" data-striped="true">
								<thead>
									<tr>
										<th data-radio="true" data-hidden="sale_id"></th>
										
										<th data-field="customers.customer_name">客户姓名</th>
										<th data-field="sale_time" >销售时间</th>
										<th data-field="unit_price">销售单价</th>
										<th data-field="rooms.room_name">房屋编号</th>
										<th data-field="discount">销售折扣</th>
										<th data-field="total_cost">销售总价</th>
										<th data-field="employees.employee_name">员工姓名</th>
