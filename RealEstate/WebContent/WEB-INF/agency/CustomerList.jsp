					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div>
									...
									<button type="button" id="active" class="btn btn-default btn-sm">
		     						...
		     						<button type="button" id="btn_edit2" class="btn btn-default btn-sm"  data-target="#upload">
							          <span class="glyphicon glyphicon-folder-close"></span>  上传合同、档案
							        </button>
		     						
						            
						            <button type="button" id="btn_upload" class="btn btn-default btn-sm"  data-target="#modalLogo">
							          <span class="glyphicon glyphicon-share"></span>下载合同、档案
							        </button>
							...
							<table id="tb" class="table table-bordered table-hover" data-toggle="table" 
											data-url="<%=path %>/customer/list" data-pagination="true" data-striped="true">
								<thead>
									<tr>
										<th data-radio="true" data-hidden="customer_id"></th>
										
										<th data-field="customer_name" >客户姓名</th>
										<th data-field="employee.employee_name">员工姓名</th>
										<th data-field="customer_gender">性别</th>
										<th data-field="identity_id" >身份证号</th>
										<th data-field="customer_phone">手机号</th>
