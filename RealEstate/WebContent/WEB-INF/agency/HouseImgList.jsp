					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<h1 align="center">户型图片</h1>
									
				 					<s:iterator value="#request.houseImgs" var="d">
							        	
							        <center>		<a href="http://localhost:8080/RealEstate/house/houseImgDelete?houseImg.id=${d.id}&houseImg.house_id=${house_id}" onclick="javascript:if(confirm('删除确认')){return true;}else{return false;}"><img style="height:550px;width: 790px" title="点击可以删除图片" src="http://localhost:8080/RealEstate/${d.house_img}"></a></center>
