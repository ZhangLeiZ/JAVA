					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div>
									...
									<button type="button"  id="btn_edit" class="btn btn-default btn-sm"   data-target="#exampleModal">
							          <span class="glyphicon glyphicon-pencil"></span>回复留言
							        </button>
							...
							<table id="tb" class="table table-bordered table-hover" data-toggle="table" 
											data-url="<%=path %>/message/list" data-pagination="true" data-striped="true">
								<thead>
									<tr>
										<th data-radio="true" data-hidden="message_id"></th>
										
										<th data-field="user.user_name">用户名称</th>
										<th data-field="buildings.buildings_name" >楼盘名称</th>
										<th data-field="message_content" >留言内容</th>
										<th data-field="reply" data-formatter="format">回复内容</th>
									  ...
									  <div class="modal-dialog" role="document">
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        	 ...
									        	 <form id="from1" method="post" class="form-horizontal" enctype="multipart/form-data" action="<%=path %>/message/updateMessage">
																...
																<div class="form-group">
																	...
																	<div class="col-lg-5">
																		<input type="text" value="onfocus=this.blur()" onfocus="this.blur()"  class="form-control" name="message.message_content"/>
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="col-lg-5">
																		<input type="text"     class="form-control" name="message.reply"/>
																	</div>
																</div>
								...
								<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
									  <div class="modal-dialog" role="document">
									    <div class="modal-content">
									      ...
									      <div class="modal-body">
									        <form id="from2" action="<%=path %>/message/deleteMessage">
...
<![endif]-->
	...
	<script src="<%=path %>/Js/Ljs/Message/message.js"></script>
