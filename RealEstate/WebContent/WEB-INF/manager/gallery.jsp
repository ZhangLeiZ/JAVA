                            ...
                            <div class=" form">
                                <form class="cmxform form-horizontal " id="commentForm" method="get" action="" novalidate="novalidate">
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">用户名称：</label>
                                        <div class="col-lg-6">
                                             <label for="cname" class="control-label">刘亦菲</label>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">昵称：</label>
                                        <div class="col-lg-6">
                                             <label for="cname" class="control-label">菲菲</label>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">生日：</label>
                                        <div class="col-lg-6">
                                             <label for="cname" class="control-label">1994-06-08</label>
                                        </div>
                                    </div>                                                      
                                    <div class="form-group">
